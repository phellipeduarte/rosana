  ...
  return (
    <section className="relative h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <h1 className="font-bold text-5xl md:text-6xl lg:text-7xl text-foreground mb-4 text-balance">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button size="lg" className="text-lg px-8 py-6 rounded-lg" asChild>
            <a href="#contato">Agendar consulta</a>
          </Button>
          <Button size="lg" variant="outline" className="text-lg px-8 py-6 rounded-lg bg-card/80 hover:bg-card" asChild>
